...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-60 h-60 sm:w-80 sm:h-80 bg-gradient-to-br from-pista-300/40 to-emerald-300/40 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-40 -left-40 w-60 h-60 sm:w-80 sm:h-80 bg-gradient-to-tr from-teal-300/40 to-cyan-300/40 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 sm:w-96 sm:h-96 bg-gradient-to-r from-pista-200/20 to-emerald-200/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>

      <div className="relative z-10 w-full max-w-lg animate-fade-in">
        {/* Logo/Header Section */}
        <div className="text-center mb-6 sm:mb-8 animate-slide-down">
          <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-pista-500 to-emerald-600 rounded-2xl sm:rounded-3xl mb-4 sm:mb-6 shadow-2xl shadow-pista-500/50 transform hover:scale-110 hover:rotate-6 transition-all duration-500 animate-bounce-slow">
            <span className="text-3xl sm:text-4xl animate-pulse">🏨</span>
          </div>
          
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pista-800 via-emerald-700 to-teal-700 mb-2 sm:mb-3 tracking-tight animate-gradient px-2">
            GRAND VALLEY
          </h1>
          <div className="inline-block px-4 sm:px-6 py-1.5 sm:py-2 bg-gradient-to-r from-pista-500/20 to-emerald-500/20 rounded-full border border-pista-300/50 backdrop-blur-sm mb-3 sm:mb-4 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <p className="text-base sm:text-lg font-semibold text-pista-800">Resort Services</p>
          </div>
          
          <p className="text-sm sm:text-base text-gray-600 max-w-md mx-auto leading-relaxed px-4 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            Experience seamless dining, housekeeping, and concierge services at your fingertips
          </p>
        </div>

        {/* Main Card */}
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/50 shadow-2xl shadow-pista-500/10 mb-4 sm:mb-6 animate-scale-in hover:shadow-3xl transition-shadow duration-500" style={{ animationDelay: '0.6s' }}>
          {autoDetected && (
          ...
          {!autoDetected && (
            <>
              ...
              {/* Features */}
              <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-gray-200 animate-fade-in-up" style={{ animationDelay: '1.4s' }}>
                <div className="grid grid-cols-3 gap-2 sm:gap-4">
                  <button
                    onClick={() => handleQuickAccess('menu')}
                    className="flex flex-col items-center p-3 sm:p-4 rounded-xl sm:rounded-2xl hover:bg-gradient-to-br hover:from-pista-50 hover:to-emerald-50 transition-all duration-300 group border-2 border-transparent hover:border-pista-200 transform hover:scale-105 hover:-translate-y-1"
                  >
                    <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-orange-400 to-red-500 rounded-xl sm:rounded-2xl flex items-center justify-center mb-2 sm:mb-3 shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                  ...
                  >
                    <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-xl sm:rounded-2xl flex items-center justify-center mb-2 sm:mb-3 shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                  ...
                  >
                    <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-purple-400 to-pink-500 rounded-xl sm:rounded-2xl flex items-center justify-center mb-2 sm:mb-3 shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                      <span className="text-xl sm:text-2xl">🔔</span>
                    </div>
              ...
              <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200 text-center animate-fade-in-up" style={{ animationDelay: '1.6s' }}>
                <Link 
                  href="/admin" 
                ...
                >
                  <span className="w-7 h-7 sm:w-8 sm:h-8 bg-pista-100 rounded-full flex items-center justify-center group-hover:bg-pista-200 transition-all duration-300 group-hover:rotate-12">
